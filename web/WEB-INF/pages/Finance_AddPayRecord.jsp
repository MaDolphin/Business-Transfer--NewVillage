                                        ...
                                        <div class="row-fluid">
                                            <div class="span6 ">
                                                <div class="control-group">
                                                    <label class="control-label">应收业务费单号</label>
                                                    <div class="controls">
                                                        <textarea class="large m-wrap" name="businessCost.costId" value="${businessCostInfo.costId}" readonly></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row-fluid">
                                            <div class="span6 ">
                                                <div class="control-group">
                                                    ...
                                                    <div class="controls">
                                                        <textarea class="large m-wrap" name="businessCost.charge" value="${businessCostInfo.charge}"></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row-fluid">
                                            <div class="span6 ">
                                                <div class="control-group">
                                                    ...
                                                    <div class="controls">
                                                        <textarea class="large m-wrap" name="businessCost.refund" value="${businessCostInfo.refund}"></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
